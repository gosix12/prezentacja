...
def info_card(title, value, color, icon):
    st.markdown(
        ...
        ">
            ...
            <div style="font-weight: bold; font-size: 0.9em;">{title}</div>
...
# Lista unikalnych kategorii (pobierana z kluczy słownika)
 ...
 st.markdown("### 📦 Przegląd według kategorii leków")
...
with tab7:
        ...
        with col3:
            ...
            # ------------------ PIERWSZE PODIUM ------------------
            st.markdown("### 🏆 Najczęstsze rodzaje promocji (wg liczby wystąpień)")
